  ...
  projects: [
    {
      title: "SQL",
      description:
        "An educational SQL engine based on SQLite, with query-compilation, a bytecode VM, and B+Tree storage engine, built from scratch",
...
function createStyle3() {
  ...
  topRight.appendChild(
    createSocialLink("youtube", portfolioData.social.youtube),
  );
  topRight.appendChild(
    createSocialLink("linkedin", portfolioData.social.linkedin),
  );
